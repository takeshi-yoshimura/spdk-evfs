...
int cxlflash_multiqpair_aread(cxlflash_multiqpair_t * qpairs, void * buf, uint64_t lba, uint64_t nblocks, long timeout_nsec);
int cxlflash_multiqpair_awrite(cxlflash_multiqpair_t * qpairs, void * buf, uint64_t lba, uint64_t nblocks, long timeout_nsec);
int cxlflash_multiqpair_aunmap(cxlflash_multiqpair_t * qpairs, void * buf, uint64_t lba, uint64_t nblocks, long timeout_nsec);
