...
struct dk_cxlflash_attach * cxlflash_ioctl_attach(char *path, int mode, int * fd);
int cxlflash_ioctl_detach(int fd, struct dk_cxlflash_attach * attached);
struct dk_cxlflash_udirect * cxlflash_ioctl_udirect(int fd, struct dk_cxlflash_attach * attached);
struct dk_cxlflash_uvirtual * cxlflash_ioctl_uvirtual(int fd, struct dk_cxlflash_attach * attached, __u64 lun_size);
int cxlflash_ioctl_release_udirect(int fd, struct dk_cxlflash_udirect *udirect);
int cxlflash_ioctl_release_uvirt(int fd, struct dk_cxlflash_uvirtual *uvirt);
